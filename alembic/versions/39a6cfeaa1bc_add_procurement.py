...
def upgrade() -> None:
    ...
    sa.Column('category', sa.Enum('MATERIAL_SUPPLIER', 'SUBCONTRACTOR', 'EQUIPMENT_RENTAL', 'CONSULTANT', 'OTHER', name='vendorcategory'), nullable=False),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'SENT', 'CLOSED', 'CANCELLED', name='rfqstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('RECEIVED', 'UNDER_REVIEW', 'ACCEPTED', 'REJECTED', name='quotationstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'PENDING_APPROVAL', 'APPROVED', 'SENT', 'PARTIALLY_RECEIVED', 'FULLY_RECEIVED', 'CANCELLED', name='postatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'CONFIRMED', 'REJECTED', name='grnstatus'), nullable=False),
